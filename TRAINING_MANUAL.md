...
## 9. 🐳 Server Maintenance & Log Rotation (Docker)
Since this project runs inside a Docker container (managed by Easypanel), logs from Next.js and n8n accumulate on the host machine disk over time. 

### 🧹 Quick Clean: Free Up Space Instantly
